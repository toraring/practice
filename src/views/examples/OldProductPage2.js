...
const carouselItems = [
  {
    src: require("assets/img/air2.jpg"),
    altText: "Slide 1",
    caption: "2018 윈터 컬렉션"
  },
  {
    src: require("assets/img/air3.jpg"),
    altText: "Slide 2",
    caption: "cryptoberry는 정품만 취급합니다"
  },
  {
    src: require("assets/img/air4.jpg"),
    altText: "Slide 3",
...
class OldProductPage2 extends React.Component {
  componentDidMount() {
              ...
              <div className="section">
                <Container>
                  ...
                  <Col className="mx-auto col-md-12 col-lg-6">
                    <h2 className="title">Air Jordan shoes</h2>
...
export default OldProductPage2;
